...
(function () {
  ...
  // 1. DATA ACCESS
  const GALLERY = window.SACERDOTI_GALLERY || {
    estuches: [],
  ...
  function makeGalleryCard(item, tag) {
    return `
      <div class="gallery-card" data-category="${item.category}" data-full="${item.rel_path}">
  ...
  const views = {
              ...
              <div class="hero-grid">
                <div class="hero-content">
                  ...
                  <div class="hero-actions">
                    <a href="#productos" class="btn btn-primary btn-lg">Ver Catálogo de Productos</a>
                    <a href="#cotizar" class="btn btn-accent btn-lg">Cotizar Proyecto</a>
                  </div>
              ...
              <div class="grid-4">
                <div class="product-category-card">
                  ...
                  <div class="product-category-body">
                    ...
                    <a href="#productos/estuches" class="btn btn-sm btn-outline">Ver Catálogo &rarr;</a>
                  </div>
                </div>
                ...
                <div class="product-category-card">
                  ...
                  <div class="product-category-body">
                    ...
                    <a href="#productos/estuchespromocionales" class="btn btn-sm btn-outline">Ver Catálogo &rarr;</a>
                  </div>
                </div>
                ...
                <div class="product-category-card">
                  ...
                  <div class="product-category-body">
                    ...
                    <a href="#productos/materialpop" class="btn btn-sm btn-outline">Ver Catálogo &rarr;</a>
                  </div>
                </div>
                ...
                <div class="product-category-card">
                  ...
                  <div class="product-category-body">
                    ...
                    <a href="#productos/promocion" class="btn btn-sm btn-outline">Ver Catálogo &rarr;</a>
                  </div>
                </div>
              </div>

              <div style="text-align: center; margin-top: 40px;">
                <a href="#productos" class="btn btn-primary btn-lg">Explorar Todo el Catálogo &rarr;</a>
              </div>
            </div>
          </section>
            ...
            <div class="container">
              <div class="grid-2" style="align-items: center;">
                <div>
                  ...
                  <a href="#procesos" class="btn btn-accent btn-lg">Conocer Todos los Procesos &rarr;</a>
                </div>
          ...
          <section class="section section-alt">
            <div class="container">
              ...
              <div style="text-align: center; margin-top: 36px;">
                <a href="#clientes" class="btn btn-outline">Ver Nómina Completa de Clientes &rarr;</a>
              </div>
            </div>
          </section>

          <!-- BANNER COTIZADOR CTA -->
          <section class="section">
            <div class="container">
              <div style="background: linear-gradient(135deg, var(--color-primary-900), var(--color-primary-850)); border-radius: var(--radius-xl); padding: 56px 48px; color: #ffffff; text-align: center; max-width: 960px; margin: 0 auto; box-shadow: var(--shadow-xl);">
                ...
                <div style="display: flex; justify-content: center; gap: 16px; flex-wrap: wrap;">
                  <a href="#cotizar" class="btn btn-accent btn-lg">Cotizar Proyecto Ahora</a>
                  <a href="#contacto" class="btn btn-outline-white btn-lg">Contacto Institucional</a>
                </div>
              </div>
            </div>
          </section>
    ...
    historia: function () {
      return `
        <div class="spa-view">
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container container-narrow">
              ...
              <div style="margin-bottom: 40px;">
                ...
                <div class="pillars-grid">
                  ...
                  <div class="pillar-card"><div class="pillar-number">3</div><div class="pillar-content"><h4>Servicio</h4><p>Acompañamiento personalizado.</p></div></div>
                  <div class="pillar-card"><div class="pillar-number">4</div><div class="pillar-content"><h4>Calidad</h4><p>Estándares rigurosos en cada pliego.</p></div></div>
                  <div class="pillar-card"><div class="pillar-number">5</div><div class="pillar-content"><h4>Innovación</h4><p>Tecnologías de vanguardia.</p></div></div>
                  <div class="pillar-card"><div class="pillar-number">6</div><div class="pillar-content"><h4>Control</h4><p>Supervisión en cada etapa.</p></div></div>
                  <div class="pillar-card"><div class="pillar-number">7</div><div class="pillar-content"><h4>Comunicación</h4><p>Reporte constante con el cliente.</p></div></div>
                  <div class="pillar-card"><div class="pillar-number">8</div><div class="pillar-content"><h4>Cumplimiento</h4><p>Compromiso con los tiempos acordados.</p></div></div>
                </div>
              </div>

              <div style="text-align: center;">
                <a href="#cotizar" class="btn btn-accent btn-lg">Solicitar Cotización de Producción</a>
              </div>
            </div>
          </section>
        </div>
          ...
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container">
              <div class="section-header">
                ...
                <p class="section-description">
                  Desarrollamos departamentos interdisciplinados para la cobertura total de todas las áreas bajo un mismo techo.
                </p>
              </div>
              ...
              <div style="display: flex; flex-direction: column; gap: 24px; max-width: 960px; margin: 0 auto;">
                <div class="feature-card" style="border-left: 4px solid var(--color-accent-600);">
                  ...
                  <ul style="display: flex; flex-direction: column; gap: 8px; color: var(--color-text-body); font-size: 0.9375rem;">
                    <li>• <strong>Creación de originales:</strong> Modelado estructural y diseño de packaging.</li>
                    <li>• <strong>Fotografía digital:</strong> Toma en estudio con iluminación calibrada.</li>
                    <li>• <strong>Retoque digital:</strong> Preparación cromática y perfiles de color industrial.</li>
                  </ul>
                </div>
                ...
                <div class="feature-card" style="border-left: 4px solid var(--color-accent-600);">
                  ...
                  <ul style="display: flex; flex-direction: column; gap: 8px; color: var(--color-text-body); font-size: 0.9375rem;">
                    <li>• <strong>Preparación de originales:</strong> CTP (Computer to Plate) de alta resolución y pruebas de contrato.</li>
                    <li>• <strong>Control de farmacopea:</strong> Verificación de normativas farmacéuticas y códigos de barra.</li>
                  </ul>
                </div>
                ...
                <div class="feature-card" style="border-left: 4px solid var(--color-accent-600);">
                  ...
                  <ul style="display: flex; flex-direction: column; gap: 8px; color: var(--color-text-body); font-size: 0.9375rem;">
                    <li>• <strong>Impresión en 6 colores + barniz simultáneo:</strong> Con túnel de secado UV.</li>
                    <li>• <strong>+25 sistemas de seguridad:</strong> Tintas reactivas, reactivos a UV, numeraciones y hologramas.</li>
                    <li>• <strong>Efectos especiales:</strong> Barnices irisados, tintas aromáticas y metalizadas.</li>
                  </ul>
                </div>
                ...
                <div class="feature-card" style="border-left: 4px solid var(--color-accent-600);">
                  ...
                  <ul style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 8px; color: var(--color-text-body); font-size: 0.9375rem;">
                    <li>• Laca UV total y sectorizada</li>
                    <li>• Hot Stamping oro y plata</li>
                    <li>• Troquelado / Relieve seco / Braille</li>
                    <li>• Doblado / Pegado lineal y automático</li>
                    <li>• Alzado, perforado, acaballado</li>
                    <li>• Termosellado y embolsado</li>
                  </ul>
                </div>
                ...
                <div class="feature-card" style="border-left: 4px solid var(--color-accent-600);">
                  ...
                  <ul style="display: flex; flex-direction: column; gap: 8px; color: var(--color-text-body); font-size: 0.9375rem;">
                    <li>• <strong>Embalaje paletizado:</strong> Encajonado e impermeabilizado.</li>
                    <li>• <strong>Distribución federal e internacional:</strong> Despachos a todo el país y exportación.</li>
                  </ul>
                </div>
              </div>
          ...
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container">
              ...
              <div style="text-align: center; margin-top: 48px;">
                <a href="#cotizar" class="btn btn-accent btn-lg">Cotizar Proyecto a Medida &rarr;</a>
              </div>
            </div>
          </section>
        </div>
          ...
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container">
              <div class="section-header">
                ...
                <p class="section-description">
                  Trabajamos junto a las empresas más exigentes de la industria farmacéutica, consumo masivo, entidades bancarias y entretenimiento.
                </p>
              </div>
              ...
              <div style="background-color: #ffffff; border: 1px solid var(--color-border); border-radius: var(--radius-xl); padding: 40px; margin-top: 48px; text-align: center; box-shadow: var(--shadow-sm);">
                ...
                <a href="#cotizar" class="btn btn-accent btn-lg">Solicitar Presupuesto de Producción</a>
              </div>
            </div>
          </section>
        </div>
    ...
    // -------------------------------------------------------------
    // VISTA: COTIZAR (FORMULARIO TÉCNICO)
    // -------------------------------------------------------------
    cotizar: function () {
      return `
        <div class="spa-view">
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container">
              <div class="section-header">
                ...
                <p class="section-description">
                  Complete las especificaciones técnicas de su trabajo para que nuestro equipo prepare una propuesta a medida con costos y plazos optimizados.
                </p>
              </div>
              ...
              <div class="contact-grid">
                <div class="contact-form-card">
                  ...
                  <form id="quoteForm">
                    ...
                    <!-- 4. MEDIDAS -->
                    <div class="form-group">
                      <label class="form-label" for="mensaje">Medidas y especificaciones *</label>
                      <textarea id="mensaje" name="mensaje" class="form-control" placeholder="Indique medidas (Base x Alto x Profundidad), colores, plazos de entrega requeridos..." required></textarea>
                    </div>
                ...
                <div>
                  <div class="contact-info-card" style="margin-bottom: 20px;">
                    <h3>Ventajas de Producir con Sacerdoti</h3>
                    <p style="margin-bottom: 16px;">Garantizamos los más altos estándares de la industria gráfica argentina.</p>

                    <ul style="display: flex; flex-direction: column; gap: 12px; color: #f1f5f9; font-size: 0.875rem;">
                      <li style="display: flex; gap: 8px;">
                        <svg width="18" height="18" fill="none" stroke="var(--color-accent-400)" viewBox="0 0 24 24" stroke-width="2" style="flex-shrink: 0;"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                        <span><strong>Producción 100% In-House:</strong> Cero tercerizaciones, asegurando plazos y confidencialidad.</span>
                      </li>
                      <li style="display: flex; gap: 8px;">
                        <svg width="18" height="18" fill="none" stroke="var(--color-accent-400)" viewBox="0 0 24 24" stroke-width="2" style="flex-shrink: 0;"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                        <span><strong>Asesoramiento Estructural:</strong> Modelado de maquetas previas.</span>
                      </li>
                      <li style="display: flex; gap: 8px;">
                        <svg width="18" height="18" fill="none" stroke="var(--color-accent-400)" viewBox="0 0 24 24" stroke-width="2" style="flex-shrink: 0;"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                        <span><strong>Calidad Certificada:</strong> Protocolos ISO 9001:2008.</span>
                      </li>
                    </ul>
                  </div>
    ...
    // -------------------------------------------------------------
    // VISTA: CONTACTO (INSTITUCIONAL & MAPA)
    // -------------------------------------------------------------
    contacto: function () {
      return `
        <div class="spa-view">
          <section class="section" style="padding-top: calc(var(--header-height) + 36px);">
            <div class="container">
              <div class="section-header">
                ...
                <p class="section-description">
                  Comuníquese con nuestras oficinas centrales y planta gráfica para consultas administrativas, proveedores o visitas técnicas.
                </p>
              </div>
              ...
              <div class="contact-grid">
                <div class="contact-info-card">
                  ...
                  <div style="padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.15);">
                    <p style="font-size: 0.8125rem; color: #94a3b8; margin-bottom: 0;">Horario: Lunes a Viernes de 8:00 a 18:00 hs.</p>
                  </div>
                </div>
  ...
  function updateActiveNav(route) {
    const mainSection = route.split('/')[0];
    document.querySelectorAll('.nav-link').forEach(link => {
      const href = link.getAttribute('href') || '';
      const linkSection = href.replace('#', '').split('/')[0];
      if (linkSection === mainSection || (mainSection === 'inicio' && linkSection === '')) {
  ...
  function handleRoute() {
    ...
    const titles = {
      inicio: 'Inicio | Sacerdoti - Empresa Gráfica',
      historia: 'Historia | Sacerdoti - Empresa Gráfica',
      procesos: 'Procesos de Producción | Sacerdoti - Empresa Gráfica',
      productos: 'Catálogo de Productos | Sacerdoti - Empresa Gráfica',
      clientes: 'Clientes | Sacerdoti - Empresa Gráfica',
      cotizar: 'Cotizar Proyecto | Sacerdoti - Empresa Gráfica',
      contacto: 'Contacto | Sacerdoti - Empresa Gráfica'
    };
    document.title = titles[mainRoute] || 'Sacerdoti - Empresa Gráfica';

    if (views[mainRoute]) {
      appContainer.innerHTML = views[mainRoute](subRoute);
  ...
  function initHeroSlider() {
    ...
    const wrap = document.querySelector('.hero-slider-card');
    if (wrap) {
  ...
  function initLightbox() {
    ...
    const imgElem = modal.querySelector('.lightbox-img-wrapper img');
    const captionTitle = modal.querySelector('.lightbox-caption h3');
    const captionDesc = modal.querySelector('.lightbox-caption p');
    ...
    function updateModal() {
      ...
      captionDesc.textContent = item.tag;
    }

    document.querySelectorAll('.gallery-card').forEach((card, idx, cards) => {
      card.addEventListener('click', () => {
        const items = Array.from(cards).map(c => ({
          src: c.getAttribute('data-full') || (c.querySelector('img') ? c.querySelector('img').src : ''),
          title: c.querySelector('.gallery-card-title') ? c.querySelector('.gallery-card-title').textContent : '',
          tag: c.querySelector('.gallery-card-tag') ? c.querySelector('.gallery-card-tag').textContent : ''
        }));
        openModal(items, idx);
      });
    });
